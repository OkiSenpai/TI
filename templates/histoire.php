...
<main>
    ...
    <div class="content">
        ...
        <h3>Capitale du siècle d'or (1584-1702)</h3>
        <p> Le XVIIe siècle est considéré comme l'âge d'or d'Amsterdam car elle devient à cette époque la ville la plus
            riche du monde. La reprise d'Anvers par les Espagnols en 1585, qui voit les bouches de l'Escaut bloquées par
            les
            Provinces-Unies se traduit par un afflux massif de bourgeois protestants qui apportent savoir-faire et
            capitaux.
            Amsterdam est alors au cœur d'un réseau mondial de commerce maritime avec les pays de la mer Baltique,
            l'Afrique, l'Amérique du Nord, le Brésil ou encore les Indes orientales. C'est ainsi que les marchands
            amstellodamois possèdent la majorité des actions de la première grande multinationale de l’Histoire, la
            Compagnie néerlandaise des Indes orientales, créée en 1602, mais également de sa rivale, la Compagnie
            néerlandaise des Indes occidentales (1621). Ces deux sociétés ont fait l'acquisition de plusieurs
            territoires
            outremer, par la suite devenus des colonies néerlandaises. Les bateaux revenant d'Indonésie chargés de
            précieuses épices font la richesse de la ville. Amsterdam rayonne à cette époque à travers toute l'Europe,
            tant
            au niveau artistique avec Rembrandt et Vermeer, que financier avec la création d'une « banque de change »
            initialement censée faciliter les échanges de monnaie, mais qui devient rapidement un pourvoyeur de fonds
            pour
            les particuliers et les entreprises, ainsi que de la première bourse de valeurs au monde en 1611. C'est
            également le cas en génie civil, avec la construction des célèbres canaux ou de l'hôtel de ville, achevé en
            1655
            sous la supervision de l'architecte Jacob van Campen, considéré par les Amstellodamois comme la huitième
            merveille du monde.</p>

        <h3>Du déclin à la modernisation (XVIIIe et XIXe siècles)</h3>
        ...
        <h3>Retour progressif au premier plan</h3>
        <p>
        ...
        <h3>Permanences, reconstruction et renouveau (XXe siècle)</h3>
        <p> Peu avant la Première Guerre mondiale, Amsterdam s'étend avec le Plan Zuid de H. P. Berlage en 1915. Malgré
        ...
        <h3>Émergence d'une ville contemporaine</h3>
        <p>
